/*********************************************************************
Program name: Ena.c
Description: Calculate the check digit from a EAN code
...
int main(void) {							// Begin
	...
	scanf_s("%1d", &D1);						// Get 12 values from user
	scanf_s("%1d%1d%1d%1d%1d", &D2, &D3, &D4, &D5, &D6);
	scanf_s("%1d%1d%1d%1d%1d%1d",
